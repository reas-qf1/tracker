...
class ChartsScreenViewModel(
    ...
    private fun artists(period: TimePeriod) =
        pagingDataFlow {
    ...
    private fun albums(period: TimePeriod) =
        pagingDataFlow {
    ...
    private fun tracks(period: TimePeriod) =
        pagingDataFlow {
    ...
    private fun artistsByPlayCount(period: TimePeriod) =
        pagingDataFlow {
    ...
    private fun albumsByPlayCount(period: TimePeriod) =
        pagingDataFlow {
    ...
    private fun tracksByPlayCount(period: TimePeriod) =
        pagingDataFlow {
